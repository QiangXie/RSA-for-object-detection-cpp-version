...
const std::string RES_POOL2_MODEL_DEF = "../predict/model/res_pool2/test.prototxt";
const std::string RES_POOL2_MODEL_WEIGHT = "../predict/output/ResNet_3b_s16/tot_wometa_1epoch";
...
const std::string RES_S16_F2R_DEF = "../predict/model/ResNet_3b_s16_f2r/test.prototxt";
const std::string RES_S16_F2R_WEIGHT = "../predict/output/ResNet_3b_s16/tot_wometa_1epoch";
const std::string TEST_IMG_NAME = "./image/test_0.jpg";
